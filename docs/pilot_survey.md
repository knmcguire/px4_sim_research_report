...
There have been some open-ended questions answered here and there that mentioned the PX4 versioning issues with the simulators, that it was difficult to know which version worked with what (or that it was inconsistent). This goes in line with what has been observed in the forum analysis (found in the appendix).
